...
export default function Layout({ children }: any) {
	...
	return (
		<div>
			<header
				className="relative flex flex-col text-white p-6 bg-no-repeat h-[500px] w-full bg-cover"
				style={{
			...
			>
				{/* Top navigation bar */}
				<div
					className={`fixed top-0 left-0 right-0 z-50 flex justify-between items-center p-6 transition-all duration-300 ${
				...
				>
					...
					<div className="hidden sm:flex flex-row items-center gap-[30px]">
						<Link href="/">
				...
				<div className="flex absolute top-[280px] flex-col gap-0">
					<h1 className="text-[25px] sm:text-[40px] p-2 border-white">
